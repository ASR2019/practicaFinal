	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		switch(request.getServletPath())
		{
			...
			case "/data":
				...
				JsonArray stock = gson.fromJson(gson.toJson(symbolStock), JsonArray.class);
				JsonArray news = gson.fromJson(gson.toJson(newsFeed), JsonArray.class);

				json.add("stock", stock);
				json.add("news", news);

				System.out.println(json.keySet().toArray());
