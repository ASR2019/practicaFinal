...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<app-stock-chart [symbol]=\"this.symbol\"></app-stock-chart>\n<app-news-table [symbol]=\"this.symbol\"></app-news-table>");
...
let DashboardComponent = class DashboardComponent {
    constructor(sidebarService, menuService, router, route) {
    ...
    addSymbol(symbol) {
        ...
        this.router.navigateByUrl(symbolUrl).then(val => {
            this.route.url.subscribe(paths => this.symbol = paths[0].path, err => this.symbol = null);
...
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()
], MainPanelComponent.prototype, "symbol", void 0);
